...
class Form(QMainWindow):
    ...
    def setupUI(self):
        ...
        # 버튼 clicked 시그널(이벤트) --> setTableWidgetData메서드(슬롯)
        self.btn.clicked.connect(self.setTableWidgetData)

        # 다중의 행과 열(엑셀) : 웹 페이지 <table><tr><td>..</td></tr></table>
        #       0열       1열 (컬럼 2개)
        # 0행   (0,0)   (0,1)   (행, 열)
        # 1행   (1,0)   (1,1)
        # 2행   (2,0)   (2,1)
        #   3행2열 --> 6개의 셀이 있는 2차원 배열
        ...
        # 컨트롤.시그널명 --> doubleClicked 슬롯 메서드 연결
    ...
    def doubleClicked(self):
        # 사용자가 어떤 행을 클릭했는지를 검색해서 웹 브라우저로 보내기
